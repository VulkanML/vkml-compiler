...
mlir::Value add(mlir::Value lhs, mlir::Value rhs, vkml::Compiler& compiler){
    auto resultType = lhs.getType(); // Assuming the result type is the same as the input types
    // auto op = compiler
    // return op;
    return mlir::Value();
}